...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button Left=findViewById(R.id.mBt9);
        Button Right=findViewById(R.id.mBt10);
        Button Go=findViewById(R.id.mBt11);
        Button Back=findViewById(R.id.mBt12);
        Button Ring=findViewById(R.id.mBt13);
